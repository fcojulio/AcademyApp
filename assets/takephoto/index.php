...
<head>
    ...
    <meta name="description" content="Capture Pic Using HTML5">
    <meta name="author" content="https://plus.google.com/+AKSHAYVANJARE">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="one-half column category">
                ...
                <br>
                <button class="button button-primary" id="capture-pic" onclick="takepicture()">Capture</button>
            </div>
            <div class="one-half column category">
                <img class="u-max-full-width" id="photo" src="images/placeholder.png">
                <br>
                <a class="button button-primary" id="download-pic" href="#" download="myimage.png" style="visibility: hidden;" >Download</a>
                <button disabled="disabled" class="button button-primary" id="upload-pic">Upload</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $("#upload-pic").click(function () {
        ...
        $.post("uploadpic.php", {picdata: picdata, dni: dni}, function (data) {       //
